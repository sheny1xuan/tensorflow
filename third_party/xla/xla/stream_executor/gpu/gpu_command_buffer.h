...
class GpuCommandBuffer : public CommandBuffer {
  // GraphNodeHandleImpl is an opaque type that won't be ODR used, hence doesn't
  // need to fully defined. It's an implementation details of the GpuNodeHandle
  // below.
  struct GraphNodeHandleImpl;

  // GraphConditionalImpl is an opaque type that won't be ODR used, hence
  // doesn't need to fully defined. It's an implementation details of the
  // GraphConditional below.
  struct GraphConditionalImpl;
 ...
 public:
  ...
  // define it.
  using GraphNodeHandle = GraphNodeHandleImpl*;
  ...
  using GraphConditionalHandle = GraphConditionalImpl*;
 ...
 private:
  ...
  // command buffer.
  absl::Status ConditionalCommand(ExecutionScopeId execution_scope_id,
                                  ConditionType type,
