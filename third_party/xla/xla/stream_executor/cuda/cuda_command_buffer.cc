...
absl::Status CudaCommandBuffer::LaunchSetIfElseConditionKernel(
  ...
  return CommandBuffer::Launch(set_if_else_condition_kernel_,
                               execution_scope_id, ThreadDim(), BlockDim(),
...
absl::Status CudaCommandBuffer::LaunchSetIfConditionKernel(
  ...
  return CommandBuffer::Launch(set_if_condition_kernel_, execution_scope_id,
                               ThreadDim(), BlockDim(),
...
absl::Status CudaCommandBuffer::LaunchSetWhileConditionKernel(
  ...
  return CommandBuffer::Launch(set_while_condition_kernel_, execution_scope_id,
                               ThreadDim(), BlockDim(),
...
absl::Status CudaCommandBuffer::LaunchSetCaseConditionKernel(
  ...
  return CommandBuffer::Launch(
      ...
      padded_handles[6], padded_handles[7], index, batch_offset,
