...
inline LiteRtResult<llvm::SmallVector<TensorUseInfo>> LiteRtGetTensorUses(
    LiteRtTensor tensor) {
...
inline LiteRtResult<TensorUseInfo> GetTensorOnlyUse(LiteRtTensor tensor) {
  LITERT_ASSIGN_OR_RETURN_RESULT(auto uses, LiteRtGetTensorUses(tensor),
                                 TensorUseInfo);
  if (uses.size() != 1) {
...
inline LiteRtResult<llvm::ArrayRef<LiteRtOp>> LiteRtGetSubgraphOps(
...
inline LiteRtResult<llvm::ArrayRef<LiteRtTensor>> LiteRtGetSubgraphInputs(
    LiteRtSubgraph subgraph) {
  LiteRtParamIndex num_inputs;
  LiteRtTensorArray inputs = nullptr;
  LITERT_RETURN_RESULT_IF_NOT_OK(
...
inline LiteRtResult<llvm::ArrayRef<LiteRtTensor>> LiteRtGetSubgraphOutputs(
    LiteRtSubgraph subgraph) {
  LiteRtParamIndex num_outputs;
  LiteRtTensorArray outputs = nullptr;
  LITERT_RETURN_RESULT_IF_NOT_OK(
...
inline bool MatchTensorHasUses(LiteRtTensor tensor,
  ...
  LITERT_ASSIGN_OR_RETURN_VAL(auto uses, LiteRtGetTensorUses(tensor), false);
